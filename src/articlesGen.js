...
exports.generate = function (articlesDir, templateDir, outputDir, partialsPath, linkPrefix, suffix, apiTree, apiLinkPrefix, toc) {
    var articles = [];
    var partials = [];
    ...
    render (tempDir, templateDir, outputDir, articles, suffix, toc);
    rmdir(tempDir);
};
...
function render (tempDir, layoutDir, outputDir, articles, suffix, tocTree) {
    for(var i=-1; ++i<articles.length;) {
        var article = articles[i];
        renderArticle (tempDir, layoutDir, outputDir, articles, article, suffix, tocTree);
    }
}

function renderArticle (tempDir, layoutDir, outputDir, articles, article, suffix, tocTree) {
    var filename = tempDir + '/' + article.path;
