...
module.exports = function (grunt) {
    grunt.registerMultiTask ('articles', 'Generates articles', function () {
        ...
        articlesGen.generate (articlesDir, templateDir, outputDir, partialsPath, linkPrefix, suffix, apiTree, apiLinkPrefix, toc);
    });
};